...
# the best model name in the model folder to be reloaded
best_model_weights = "mxnet-resnet50-weights-improvement-00-0.9062.hdf5"
...
#################################################
# Loading best weight values to the model
#################################################
...
##################################################
#  Check validation accuracy and loss before re-training
##################################################
...
print("Network Test Accuracy - Before starting re-training: {0:.4f} Test Loss: {1:.4f} "
      .format(acc_before, loss_before))
...
history_df = train_model(my_net, trainer, softmax_cross_entropy, num_epochs=3)
