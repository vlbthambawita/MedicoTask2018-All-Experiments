...
class MyNet(nn.Module):
    def __init__(self, pretrained_modle_resnet, pretrained_modle_densnet):
        ...
        self.resnet_model.fc = nn.Linear(self.resnet_num_ftrs, 1024)
       ...
       # self.densenet_model = models.densenet161(pretrained=True)
        ...
        self.densenet_model.classifier = nn.Linear(self.densenet_num_ftrs,1024)
    ...
    def forward(self, x):
        ...
        x2 = self.densenet_model(x)
        out_1 = torch.cat((x1, x2), 1)
        out_1 = torch.relu(self.fc1(out_1))
        out_1 = torch.relu(self.fc2(out_1))
...
model_ft = MyNet(pretrained_modle_densnet=pretrained_densenet,pretrained_modle_resnet=pretrained_resnet)
