...
class MyNet(nn.Module):
    def __init__(self):
        ...
        self.resnet_model.fc = nn.Linear(self.resnet_num_ftrs, 16) # changed for 2 classes
       ...
       # self.densenet_model = pretrained_modle_densnet
        ...
        self.densenet_model.classifier = nn.Linear(self.densenet_num_ftrs, 16) # changed for 2 classes
...
class MyDenseNet(nn.Module):
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            self.best_weight_file_path = "/home/vajira/simula/code_samples/mediaEval_2018_structured_v2/data/data_modified_polyps_non_polyps_only_two_classes/pytorch_models/20180904-133210:23_2_weights-improvement-04-0.9556.hdf5"
        ...
        self.fc1 = nn.Linear(32, 32) # changes 32 to 4
        self.fc2 = nn.Linear(32, 16) # 16 to  2
        # self.fc3 = nn.Linear(512, 16)
...
if arg_mode in ["re-train", "test"]:
    ...
    print('changing model outputs to 2 classes')
    fc2_num_ftrs = model_ft.fc2.in_features
    model_ft.fc2 = nn.Linear(fc2_num_ftrs, 2)
    print('changes done...!')
