...
def prepare_submission_file(image_names, predicted_labels, max_probability):
    submission_dataframe = pd.DataFrame(np.column_stack([image_names, predicted_labels]),
...
if arg_mode == "test":
   ...
   # prepare_submission_file(test_image_names, predicted_labels, None)
    exit(0)
