...
What: This code was edited to make equal RESNET50 transfer learning to pytorch implementations
'''
...
checkpoint_name = "10-epoch-test-weights-improvement-{epoch:02d}-{val_acc:.4f}.hdf5"
...
#  Optimizer (SGD)
optimizer = optimizer = optimizers.SGD(lr=0.001, decay=1e-6, momentum=0.9, nesterov=True) #optimizers.rmsprop()
...
print("Start whole layers trainig...")
...
#print("starting last layres training of the model...")
...
plot_training_history(history, plot_dir, "history_" + accuracy_plot_name)
#plot_training_history(history_2, plot_dir, "history_2" + accuracy_plot_name)
