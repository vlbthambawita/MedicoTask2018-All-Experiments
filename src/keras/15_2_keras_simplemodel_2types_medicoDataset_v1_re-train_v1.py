...
checkpoint_name = "15_2_weights-improvement-{epoch:02d}-{val_acc:.4f}.hdf5"
...
simple_model.add(layers.Conv2D(64, (3,3), activation='relu', input_shape=(trgt_sz, trgt_sz, 3)))
...
simple_model.add(layers.Conv2D(256, (3,3), activation='relu'))
simple_model.add(layers.Conv2D(256, (3,3), activation='relu'))
simple_model.add(layers.Conv2D(256, (3,3), activation='relu'))
simple_model.add(layers.MaxPool2D((2,2)))

simple_model.add(layers.Conv2D(512, (3,3), activation='relu'))
simple_model.add(layers.Conv2D(512, (3,3), activation='relu'))
simple_model.add(layers.Conv2D(512, (3,3), activation='relu'))
simple_model.add(layers.MaxPool2D((2,2)))
...
simple_model.add(layers.Dense(4096, activation='relu'))
simple_model.add(layers.Dense(4096, activation='relu'))
simple_model.add(layers.Dense(4096, activation='relu'))
...
############################################################
simple_model.load_weights(os.path.join(model_dir, best_weight_file_name))
...
history = simple_model.fit_generator(train_generator, train_generator.n // batch_size, epochs=number_of_epochs, workers=4,
