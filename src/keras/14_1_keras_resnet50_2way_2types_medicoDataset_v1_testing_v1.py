...
best_weight_file = input('Please, enter best weights value file name:') #"weights-improvement-05-0.9273.hdf5"
#model_name = best_weight_file[:-5]
...
model.load_weights(os.path.join(model_dir, best_weight_file))
...
predicted = np.round(probabilities, 0, None)#np.argmax(probabilities,axis=1) # take predicted indices
true_labels = test_generator.classes
#  Generate confusion matrix
#cm = confusion_matrix(test_generator.classes, predicted)

#  Testing values for confusion matrix
#print("test generator classes=", test_generator.classes)
...
print("accuracy score = ", accuracy_score(true_labels, predicted))
