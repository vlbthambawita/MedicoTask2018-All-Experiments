...
echo $DATE_WITH_TIME
#######################################################
model_name_save_and_load="$DATE_WITH_TIME:13_4_densenet-161_medico_16_classes_pytorch_bs25_epochs_v1"
check_point_name_format="$DATE_WITH_TIME:13_4_weights-improvement-{epoch:02d}-{val_acc:.4f}.hdf5"
...
training_file="../src/pytorch/13_5_pytorch_densenet161_medioDataset_v1_training_v1.py"
retraining_file="../src/pytorch/13_4_pytorch_densenet_medioDataset_v1_re-training_v1.py"
